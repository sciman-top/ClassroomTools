...
class IconManager:
    _icons: Dict[str, str] = {
        ...
        # 统一把“全部清除”键命名为 clear_all（图形未变）
        "clear_all": "",
        "settings": "",
        # 更直观的白板图标（画板/支架）
        "whiteboard": "",
    }
...
class FloatingToolbar(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.tool_buttons.setExclusive(True)  # 互斥
        ...
        # 这些控件用于隐藏自定义 ToolTip
        for w in (self, container, self.title_bar):
            w.installEventFilter(self)

    # ---- 自定义 ToolTip 事件策略 ----
    def eventFilter(self, obj, e):
        et = e.type()
        if isinstance(obj, QPushButton) and et == QEvent.Type.ToolTip:
            # 使用自绘 TipWindow，确保位于白板叠加层之上
            try:
            ...
            return True
        # 鼠标移动/离开/按下时隐藏
        if et in (QEvent.Type.Leave, QEvent.Type.MouseButtonPress, QEvent.Type.MouseButtonDblClick):
            self._tip.hide_tip()
...
# ---------- 数据 ----------
def load_student_data(parent: Optional[Widget]) -> Optional[pd.DataFrame]:
